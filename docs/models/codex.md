...
Last reviewed: 2026-09-15 (verified live against the official Codex models page)
...
- **`gpt-5.4` and `gpt-5.4-mini`**: the page still states they "retire from Codex
  ...
  remain listed under Other models (as of 2026-09-15). Replace `gpt-5.4` with `gpt-5.6-terra` and
