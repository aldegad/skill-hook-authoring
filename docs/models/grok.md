...
Last reviewed: 2026-09-18 (verified live against the official xAI models page,
...
- **Imagine API** (image/video generation and editing) — five documented ids under
  ...
  for it. As of 2026-09-18 the id is still listed as current on the models page.
